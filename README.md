<!-- Header: the animated mark next to the wordmark, generated by scripts/logo.mjs. One file per
     colour scheme because an SVG shown as an image cannot see the page's. -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="figures/banner-dark.svg">
  <img src="figures/banner.svg" width="640" alt="QMBL - the Quantum Many-Body Leaderboard">
</picture>
